/**
 * @module gallery
 * @description Skrypt do obsługi galerii zdjęć z funkcjonalnością wyszukiwania i trybem modalnym.
 */

/**
 * Słuchacz zdarzenia `DOMContentLoaded`, zapewniający, że wszystkie elementy DOM są w pełni załadowane przed wykonaniem kodu.
 * Inicjalizuje obsługę modalu i wyszukiwarki w galerii zdjęć.
...
document.addEventListener("DOMContentLoaded", () => {
    ...
    /**
 * Zamyka modal po kliknięciu przycisku zamykającego.
 * @returns {void}
 */
closeModal.addEventListener("click", () => {
   ...
   /**
 * Pole wejściowe do filtrowania obrazów w galerii.
